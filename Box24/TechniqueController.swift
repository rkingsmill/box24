...
class TechniqueController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    var techniqueModel = TechniqueModel()
    ...
    override func viewDidLoad() {
        ...
        //cellSize = CGSize(width:(self.view.frame.size.width-5)/2.1, height:(self.view.frame.size.width-5)/2.1)
    ...
    override open func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.workoutImage.image = techniqueModel.technique[indexPath.item].image
        cell.textLabel.text = techniqueModel.technique[indexPath.item].name
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        {
            cellSize = CGSize(width:(self.view.frame.size.width)/3.17, height:(self.view.frame.size.height)/1.03)
            return cellSize
        }
        else{
            cellSize = CGSize(width:(self.view.frame.size.width)/1.03, height:(self.view.frame.size.height)/3.15)
            return cellSize
        }
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        let workout = techniqueModel.technique[indexPath.item]
